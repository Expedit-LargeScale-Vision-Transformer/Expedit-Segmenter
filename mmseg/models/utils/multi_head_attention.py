...
def multi_head_attention_forward(
        ...
        #
        attn_output, attn_output_weights = _scaled_dot_product_attention(q, k, v, attn_mask, dropout_p, attn_temp)
...
class MultiheadAttention(BaseModule):
    ...
    def __init__(self,
        ...
        self.attn = NNMultiheadAttention(embed_dims, num_heads, attn_drop, attn_temp=attn_temp,
                                          **kwargs)
        if self.batch_first:
...
class NNMultiheadAttention(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False,
                 kdim=None, vdim=None, batch_first=False, device=None, dtype=None, attn_temp = 1.0) -> None:
    ...
    Shapes for outputs:
        ...
        if not self._qkv_same_embed_dim:
            ...
            attn_output, attn_output_weights = multi_head_attention_forward(
                ...
                training=self.training,
                key_padding_mask=key_padding_mask, need_weights=need_weights,
                attn_mask=attn_mask, attn_temp=self.attn_temp)
        if self.batch_first:
